...
if args.resume:
    ...
    checkpoint = torch.load('./checkpoint/ckpt_den.pth')
...
writer_train = SummaryWriter(log_dir='./log_den/train')
writer_test = SummaryWriter(log_dir='./log_den/test')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/ckpt_den.pth')
        best_acc = acc
