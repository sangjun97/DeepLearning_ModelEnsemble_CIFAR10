...
if args.resume:
    ...
    checkpoint = torch.load('./checkpoint/ckpt_res.pth')
...
writer_train = SummaryWriter(log_dir='./log_res/train')
writer_test = SummaryWriter(log_dir='./log_res/test')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/ckpt_res.pth')
        best_acc = acc
